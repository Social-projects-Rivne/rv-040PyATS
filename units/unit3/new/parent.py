...
class FileUtils(FileUtilsBase):
    ...
    def copyfile(self, source, destination, timeout_seconds=DEFAULT_COPY_TIMEOUT_SECONDS):
        ...
        # Get implementation
        child = self.get_child(abstraction_scheme)
        # Execute copy
        return child.copyfile(source, destination, timeout_seconds, upload=from_scheme_is_local)
