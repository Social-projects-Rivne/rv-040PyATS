"""IOSXR unit tests for Genie conf."""
...
class TestInterfaces(TestCase):
    ...
    def setUp(self):
        ...
        Genie.testbed = testbed
        # Device
        self.dev1 = Device(name='uut', testbed=testbed, os='iosxr')
        # Interface
        self.intf1 = Interface(name='FastEthernet0/0', device=self.dev1)
    ...
    def test_cli_config(self):
        ...
        key.bfd_interface_name = 'FastEthernet0/0'
        key.minimum_delay = 5
        key.reload_delay = 10
        key.mac_refresh = 20
        key.use_bia = True
